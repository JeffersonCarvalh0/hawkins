...
urlpatterns += i18n_patterns(
    ...
    path('student/detail/<int:registry>', views.StudentDetail.as_view(), name='student_detail'),
    path('student/update', views.StudentUpdate.as_view(), name='student_update'),
    path('student/delete', views.StudentDelete.as_view(), name='student_delete'),
